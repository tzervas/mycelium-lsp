# Gap status — `mycelium-lsp`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-lsp` |
| **Role** | LSP facade |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-lsp-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | none |
| **Related issues** | Tooling surface FR-S5 |
